...
%preamble
\usepackage{amsmath} %package for some advanced math features like matrices , etc
\usepackage{hyperref}
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue}

%setting various variables/commands to be used in the document
\title{Hello World!}
\author{Your Name}
\date{January 1, 1831}
...
\begin{document}
	\maketitle %prebuilt command that outputs the title,author,date set in the preamble
